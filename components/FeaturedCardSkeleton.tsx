      ...
      >
        <View className="w-60 h-80 p-5">
          <View className="items-center">
            <Animated.View
              className="h-40 w-40 rounded-full overflow-hidden border border-qasid-gold/20 bg-gray-700/30"
              style={[
                pulseStyle,
                {
                  shadowColor: GOLD,
          ...
          <View className="mt-auto">
            <View className="rounded-2xl border border-white/8 bg-black/30 px-4 py-4">
              <View className="flex-1 justify-center">
                <Animated.View
                  className="h-3 w-20 rounded bg-gray-700/25 mb-2"
                  style={pulseStyle}
                />
                <Animated.View
                  className="h-5 w-40 rounded bg-gray-700/30"
                  style={pulseStyle}
                />
                <Animated.View
                  className="h-3 w-24 rounded bg-gray-700/20 mt-4"
                  style={pulseStyle}
                />
              </View>
            </View>
